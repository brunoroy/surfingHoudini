...
//	#include "mdebug.h"	
	...
	public:
		...
		virtual Matrix &Basis (Math::Vector3DF &c1, Math::Vector3DF &c2, Math::Vector3DF &c3)=0;
	...
	public:
		...
		inline MatrixC &Basis (Math::Vector3DF &c1, Math::Vector3DF &c2, Math::Vector3DF &c3);
	...
	public:
		...
		inline MatrixI &Basis (Math::Vector3DF &c1, Math::Vector3DF &c2, Math::Vector3DF &c3);
	...
	public:	
		...
		inline MatrixF &Basis (const Math::Vector3DF &c1, const Math::Vector3DF &c2, const Math::Vector3DF &c3);
		...
		inline int GetLength(void);
		inline VTYPE *GetData(void);
		inline void GetRowVec (int r, Math::Vector3DF &v);
	...
	public:	
		...
		inline Matrix4F &Basis (const Math::Vector3DF &c1, const Math::Vector3DF &c2, const Math::Vector3DF &c3);		

		// Scale-Rotate-Translate (compound matrix)
		inline Matrix4F &SRT (const Math::Vector3DF &c1, const Math::Vector3DF &c2, const Math::Vector3DF &c3, const Math::Vector3DF& t, const Math::Vector3DF& s);
		inline Matrix4F &SRT (const Math::Vector3DF &c1, const Math::Vector3DF &c2, const Math::Vector3DF &c3, const Math::Vector3DF& t, const float s);

		// invTranslate-invRotate-invScale (compound matrix)
		inline Matrix4F &InvTRS (const Math::Vector3DF &c1, const Math::Vector3DF &c2, const Math::Vector3DF &c3, const Math::Vector3DF& t, const Math::Vector3DF& s);
		inline Matrix4F &InvTRS (const Math::Vector3DF &c1, const Math::Vector3DF &c2, const Math::Vector3DF &c3, const Math::Vector3DF& t, const float s);
