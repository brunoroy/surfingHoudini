...
*/
		...
		inline bool operator== (const Vector3DF b);
		...
		inline double Dot(const Vector3DC &v) const;
		inline double Dot(const Vector3DI &v) const;
		inline double Dot(const Vector3DF &v) const;
